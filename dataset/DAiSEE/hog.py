...
sub_data = [filename for filename in os.listdir(data_path) if os.path.isdir(os.path.join(data_path,filename))]
...
for folder in hist_folder_list:
  ...
  try:
    ...
    print(f"Not a directory {data_path}: {e}")
    break
  ...
  for sub_folder in sub_folder_list:
    ...
    for video in person_videos_list[0:1]:
      ...
      try:
        ...
        print(f"Unable to open {data_path}: {e}")
        break
